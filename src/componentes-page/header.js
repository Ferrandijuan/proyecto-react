...
import { ThemeContext } from '../componentes/ThemePage';
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            >
              <BiCart size="2rem" />
              {!isEmpty && <span style={{ position: 'relative', left: '-20px', top: '-18px'}}>{totalItems}</span>}
              <span style={{ marginLeft: !isEmpty ? '-12px': 0}}>Carrito</span>
            </Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
